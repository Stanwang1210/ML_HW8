# -*- coding: utf-8 -*-
"""
Created on Wed May 20 10:42:08 2020
...
class Decoder(nn.Module):
  ...
  def forward(self, input, hidden, encoder_outputs):
    ...
    if self.isatt:
      ...
      # exit()
      # attn = torch.rand((config.batch_size,self.hid_dim,config.emb_dim)).cuda()
      # attn [batch size, hid_dim * 2 , emb dim  ]
      # TODO: 在這裡決定如何使用 Attention，e.g. 相加 或是 接在後面， 請注意維度變化
      # print("attn",attn.shape)
      # print("embedded shape",embedded.shape)
      # print("embedded squeeze shape",embedded.squeeze(1).shape)
      # exit()
      # embedded = torch.cat((embedded.squeeze(1), attn), 1)
...
plt.figure()
train_losses = np.load("ckpts/cktp_20200516-164228/train_losses.npy")
plt.plot(train_losses)
print(len(train_losses))
plt.xlabel('次數')
plt.ylabel('loss')
plt.title('train loss')
plt.savefig(os.path.join("ckpts/cktp_20200516-164228/","train_loss.png"))
...
# plt.show()
plt.savefig(os.path.join(self.store_model_path,"validation_loss.png"))


"""## BLEU score"""

import matplotlib.pyplot as plt
plt.figure(os.path.join(self.store_model_path,"BLEU_score.png"))
plt.plot(bleu_scores)
plt.xlabel('次數')
plt.ylabel('BLEU score')
plt.title('BLEU score')
# plt.show()
plt.savefig(os.path.join(self.store_model_path,"BLEU_score.png"))
