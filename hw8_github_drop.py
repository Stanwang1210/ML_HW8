# -*- coding: utf-8 -*-
"""
Created on Thu May 21 21:20:43 2020

@author: 王式珩
"""

# -*- coding: utf-8 -*-
"""Copy of hw8_seq2seq.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1tM5m06HtWtsaOy5VD1Poo1uMzSYaw0yM
...
class Attention(nn.Module):
  ...
  def forward(self, encoder_outputs, decoder_hidden,decoder_input):
    ...
    att_scaled = F.relu(att_caten) #to (0, 1)
    return att_scaled
...
def save_model(model, optimizer, store_model_path, step):
  torch.save(model.state_dict(), f'{store_model_path}/model_git_drop.ckpt')
  return
...
class configurations(object):
  def __init__(self):
    ...
    self.load_model_path = "./ckpt/model_git_drop"           # 載入模型的位置 e.g. "./ckpt/model_{step}" 
